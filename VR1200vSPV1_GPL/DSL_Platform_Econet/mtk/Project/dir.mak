...
MODULES_WIFI_RATELIMIT_DIR=$(MODULES_PRIV_SRC_DIR)/net/wifi_ratelimit
...
MODULES_IQOS_DIR=$(MODULES_PRIV_SRC_DIR)/qos-appidentify
MODULES_XTAPP_DIR=$(MODULES_PRIV_SRC_DIR)/xt_app
...
MT7612EAP_DIR=$(MODULES_PRIV_SRC_DIR)/wifi/MT7612E_LinuxAP_3.0.4.0.P1_DPA
...
APP_COMPILEOPTION_LIB_DIR=$(APP_PRIVATE_DIR)/compileoption_lib
...
MODULES_PCM_DIR=$(MODULES_MTK_DSP_DIR)/pcm
...
APP_API_LIB_GPON_DIR=$(APP_PRIVATE_DIR)/API/lib/gpon
APP_API_LIB_ATM_DIR=$(APP_PRIVATE_DIR)/API/lib/atm
APP_API_LIB_VDSL_DIR=$(APP_PRIVATE_DIR)/API/lib/vdsl
APP_API_LIB_EPON_DIR=$(APP_PRIVATE_DIR)/API/lib/epon
APP_API_LIB_PPE_DIR=$(APP_PRIVATE_DIR)/API/lib/ppe
APP_API_LIB_QDMA_DIR=$(APP_PRIVATE_DIR)/API/lib/qdma
APP_API_LIB_PCIE_DIR=$(APP_PRIVATE_DIR)/API/lib/pcie
APP_API_LIB_FE_DIR=$(APP_PRIVATE_DIR)/API/lib/fe
