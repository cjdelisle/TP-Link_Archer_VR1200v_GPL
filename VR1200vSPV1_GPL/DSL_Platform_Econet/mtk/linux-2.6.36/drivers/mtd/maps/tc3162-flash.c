...
#undef TCSUPPORT_MTD_PARTITIONS_CMDLINE
#endif
...
/* changed by yangxv,2013.02.27, use this parameter in spiflash_tc3162.c */
#if 0
...
#else
struct map_info tc3162_map = {
       .name = "tc3162",
       .size = WINDOW_SIZE,
       .bankwidth = BUSWIDTH,
       .phys = WINDOW_ADDR,
};
EXPORT_SYMBOL(tc3162_map);
#endif
#if 0
...
/* changed by yangxv for W8930G, 2008.06.10 */
...
static struct mtd_partition tc3162_parts[] = {
	...
	{ 									    /* 5th partition */ 
		  name	     : "config",			/* romfile filesystem section */ 
		  size	     : 0x00010000,	        /* Size */ 
		  offset	 : MTDPART_OFS_APPEND   /* Append after kernel section */ 
	},
	{ 									    /* 7th partition */ 
		  name	     : "radio",			    /* Radio filesystem section */ 
		  size       : 0x00010000,    		/* Occupy rest of flash */
		  offset	 : MTDPART_OFS_APPEND   /* Append after kernel section */ 
	}
};
...
//		  mask_flags : MTD_WRITEABLE	 	/* This partition is not writable */
	...
	{
		name	   : "rootfs",			  /* Root filesystem section */
		size	  	 : 0x00da0000,		  /* Size */ 
		offset	   : MTDPART_OFS_APPEND   /* Append after kernel section */
	},
#ifdef CONFIG_ISP_CONFIG
	{
		  name	     : "ispconfig",			/* romfile filesystem section */ 
		  size	     : 0x00010000,	        /* Size */ 
		  offset	 : MTDPART_OFS_APPEND   /* Append after kernel section */ 		
