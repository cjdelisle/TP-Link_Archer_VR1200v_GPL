...
//#define	SUPPORT_METABOLIC_MEDIA_PORT	0//lizhanbo-for Italy-WISP special
#	endif
...
/* 
 * brief	Now,we only supply one function in this macro. 
 *			1.use domain name to find acc for the Netcube.
 *			Note: This function should not be included in other situation!
 */
#	ifndef INCLUDE_NETCUBE
#	define INCLUDE_NETCUBE	0
#	endif

/* 
 * brief	implement interface bound via ip policy route.
 *			add by yuanjp 2015/8/17
 */
#	ifndef INCLUDE_FWMARK
#	define INCLUDE_FWMARK	1
#	endif
