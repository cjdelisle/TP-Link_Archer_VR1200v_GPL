...
/**yuchuwei, there is a error when pjsip receives message from CM
* @hideinitializer
* socket error receive message from CM
*/
#define PJ_ESIPTOCMSOCKERR	(PJ_ERRNO_START_STATUS + 23)/*70023*/

/**yuchuwei
* @hideinitializer
* CM asks that pjSIP exits without unregister
*/
#define PJ_EEXITNOUNREG	(PJ_ERRNO_START_STATUS + 24)/*70024*/

/**lizhanbo
* @@hideinitializer
* DNS Query
*/
#define PJ_EDNSSRVNEXT (PJ_ERRNO_START_STATUS + 25) /*70025*/
#define PJ_EDNSSRVNONE (PJ_ERRNO_START_STATUS + 26) /*70026*/
