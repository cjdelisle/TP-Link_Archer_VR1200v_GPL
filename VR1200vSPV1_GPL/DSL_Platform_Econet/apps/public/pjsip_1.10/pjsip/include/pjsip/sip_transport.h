...
struct pjsip_rx_data
{
	...
	/* 
	 * brief	"P-Asserted-Identity" header containing display information.
	 *	By YuChuwei, For Telefonica
	 */
	pjsip_p_asserted_identity_hdr *assertedId;

	/* 
	 * brief	"P-Prefered-Identity" header 
	 *	By YuChuwei, For Telefonica
	 */
	pjsip_p_prefered_identity_hdr *preferedId;
#endif
...
struct pjsip_tx_data
{
	...
	/** lizhanbo-dns pointer to the asyn query object */
	void *dns_obj;
    ...
    } dest_info, dummy_dest_info; /*ycw-20120611:use dummy_dest_info to pass target info
								 from dialog.*/
