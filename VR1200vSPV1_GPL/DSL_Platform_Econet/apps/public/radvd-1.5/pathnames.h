...
/* Added by ranjie 11Dec15. For RFC 7084 G-4 */
#define PATH_PROC_NET_IPV6_ROUTE "/proc/net/ipv6_route"
#define IPV6_ROUTE_ANY_ADDRESS	"00000000000000000000000000000000"
/* End add */
#else /* BSD */
