...
#ifdef INCLUDE_SIMPLE_DIAGNOSTICS
	CMSG_SET_LOCAL_DOMAIN_NAME = 2044,
	CMSG_DIAGNOSTICS_START = 2045,
#endif
...
#ifdef INCLUDE_PORT_MIRRORING
	CMSG_ID_PORTMIRROR_TIMER = 36,
#endif

#ifdef INCLUDE_SIMPLE_DIAGNOSTICS
	CMSG_ID_DIAGNOSTICS = 37,
#endif
...
#ifdef INCLUDE_SIMPLE_DIAGNOSTICS
typedef struct _DIAGNOSTICS_MSG
{
	unsigned char type;
	char host[32];
	char intf[16];
